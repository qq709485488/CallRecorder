...
v4: Remove old code signature before injection, then ldid -S will re-sign.
    Use LC_LOAD_DYLIB (strong link) - app won't crash if dylib fails to load.
    This is the safest combination: clean signature + strong link.
"""
...
LC_LOAD_DYLIB = 0x0C  # strong link - guaranteed to load at startup
